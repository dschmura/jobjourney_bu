  ...
  set :application,     "jobjourney"
  set :repo_url,        "git@github.com:dschmura/jobjourney.git"
  set :user,            'deployer'
  ...
  set :deploy_to,       "/home/#{fetch(:user)}/apps/jobjourney"
  # Puma specific settings
  set :puma_bind,       "unix://#{shared_path}/tmp/sockets/jobjourney-puma.sock"
